export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center text-center py-24 bg-gradient-to-b from-white to-gray-50">
      ...
      <a href="http://brofus.me/" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-8 py-4 rounded-md text-lg font-semibold hover:bg-gray-900 transition transform hover:-translate-y-1 hover:shadow-lg duration-200">Découvrir Brofus</a>
    </section>
  );
} 